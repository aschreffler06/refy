...
export class InfoCommand {
    constructor() {
        this.names = [Lang.getRef('chatCommands.info', Language.Default)];
        ...
        switch (args.option) {
            ...
            case InfoOption.DEV: {
                ...
                if (intr.client.shard) {
                    try {
                        ...
                        if (error.name.includes('ShardingInProcess')) {
                            await InteractionUtils.send(intr, Lang.getEmbed('errorEmbeds.startupInProcess', data.lang));
                            return;
                        }
                        else {
                            throw error;
                ...
                embed = Lang.getEmbed('displayEmbeds.dev', data.lang, {
                    ...
                    RSS_SIZE_PER_SERVER: serverCount > 0
