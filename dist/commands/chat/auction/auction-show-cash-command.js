...
export class AuctionShowCashCommand {
    constructor() {
        this.names = [Lang.getRef('chatCommands.auctionShowCash', Language.Default)];
...
//# sourceMappingURL=auction-show-cash-command.js.map