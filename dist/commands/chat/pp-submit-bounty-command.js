...
export class PpSubmitBountyCommand {
    ...
    async execute(intr, data) {
        ...
        if (bountyWon) {
            ...
            await match.save();
            await InteractionUtils.send(intr, `Congratulations! Your play has met the bounty condition for **${play.title} [${play.version}]**! The bounty is now claimed for your team **${team.name}** at #${scores.indexOf(score) + 1} on the leaderboard.`);
        }
        else {
