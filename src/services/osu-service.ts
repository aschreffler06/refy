...
export class OsuService {
    ...
    public async getUser({
        ...
        username = null,
        mode = null,
    }: GetUserParams): Promise<OsuUserInfoDTO> {
    ...
    public async getUserAllModes({
        id = null,
        username = null,
    }: GetUserParams): Promise<{ osu: number; taiko: number; fruits: number; mania: number }> {
        ...
        for (const play of recentPlays.data) {
            scores.push(
                new OsuScoreDTO(
                    ...
                    play.statistics.count_geki,
                    play.statistics.count_katu,
                    play.max_combo,
